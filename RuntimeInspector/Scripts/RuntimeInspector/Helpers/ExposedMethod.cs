	...
	public struct ExposedMethod
	{
		...
		public bool VisibleWhenInitialized
		{
			get
			{
				...
				return ( properties.Visibility & ButtonVisibility.InitializedObjects ) == ButtonVisibility.InitializedObjects;
			}
		}
		...
		public bool VisibleWhenUninitialized
		{
			get
			{
				...
				return ( properties.Visibility & ButtonVisibility.UninitializedObjects ) == ButtonVisibility.UninitializedObjects;
			}
		}
